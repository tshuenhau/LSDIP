    ...
    <View style={styles.container}>
      <View style={styles.card}>
        ...
        <View style={styles.inputContainer}>
          <Text style={styles.inputLabel}>1 Dollar = {currentCashToPoint} Points</Text>
        </View>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.inputContainer}>
          <Text style={styles.inputLabel}>1 Point = ${currentPointToCash}</Text>
        </View>
      </View>
    </View>
  );
...
export default CustomerViewMembership;
